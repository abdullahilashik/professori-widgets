...
class Professional_Activities_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'CPT: Professional Activities', 'tpw' );
    }
    ...
    public function get_categories() {
        return [ 'basic' ]; // Or your custom category
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Professional Activities', 'tpw' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .activities-grid' => 'grid-template-columns: repeat({{VALUE}}, minmax(0, 1fr));',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        // Use a wrapper class to apply the grid styles from the control
        $this->add_render_attribute( 'grid', 'class', 'activities-grid grid gap-8' );
        ?>
        <div class="bg-white rounded-lg shadow-md p-6 md:p-8">
            ...
            <?php else: ?>
                <p>No professional activities have been added yet. Please create some "Activity Groups" and assign "Activity" posts to them.</p>
            <?php endif; ?>
        </div>
        <?php
    }
